              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                {highlights.map((item, index) => (
                  <ScrollReveal key={item.title} animation="zoom" delay={200 + index * 100}>
                    <div className="glass-card p-4 hover-lift h-full">
              ...
              <div className="grid grid-cols-5 gap-4">
                {techStack.map((tech, index) => (
                  <ScrollReveal key={tech.name} animation="zoom" delay={300 + index * 50}>
                    <div className="group flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-primary/10 transition-all cursor-pointer">
                      <img
                        src={tech.icon}
                        alt={tech.name}
